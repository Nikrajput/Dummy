...
const SignUpPage = ({ history }) => (
  <div>
    ...
    <div className="cardd">
      <h3 className="centered"><NavLink to="/" tag={Link}><img src={`${logo}`} width="280px" style={{paddingBottom:"0px"}}/></NavLink></h3>
      ...
      <div>
        ...
        <Form onSubmit={this.onSubmit}>
          ...
          <div className="text-center">
            <button  className="buttonsignin" disabled={isInvalid} type="submit">
              Sign Up
            </button>
          </div>
        </Form>
        <p style={{textAlign:"right",fontSize:"18px",paddingTop:"10px"}}>
          <Link to={routes.SIGN_IN}><span style={{color:"white"}}>Login</span></Link>
        </p>
      </div>
    );
  }
...
const SignUpLink = () => (
  <span style={{color:"white",fontSize:"11px",textAlign:"right",paddingLeft:"30px"}}>
    NEW USER?<Link to={routes.SIGN_UP}><span style={{color:"white"}}> REGISTER</span></Link>
  </span>
);
